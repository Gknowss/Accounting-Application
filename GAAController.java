...
public class GAAController implements Initializable{
	...
	// Indicates and validates connection to Database
	...
	// Upon running, Login page is displayed and searches db for valid user and pass.
